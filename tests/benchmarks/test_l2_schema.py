"""L2 token schema benchmarks: skill files must be <= 2200 tokens."""
...
def test_codex_skill_under_2200_tokens() -> None:
    """L2: Codex SKILL.md must be <= 2200 tokens."""
    ...
    assert tokens <= 2200, f"Codex skill: {tokens} tokens > 2200 limit"


def test_claude_skill_under_2200_tokens() -> None:
    """L2: Claude atls.md must be <= 2200 tokens."""
    ...
    assert tokens <= 2200, f"Claude skill: {tokens} tokens > 2200 limit"
